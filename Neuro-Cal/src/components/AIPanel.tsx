...
export const AIPanel = ({ upcomingEvents, onCreateEvent }: AIPanelProps) => {
  ...
  return (
    <div className={`${isMobile ? 'w-full border-t border-border' : 'w-full border-l border-border'} bg-gradient-card p-4 md:p-6 overflow-y-auto max-h-full`}>
      <div className="flex flex-col lg:flex-row gap-4 md:gap-6">
        {/* AI Assistant */}
        <Card className="border-primary/20 bg-gradient-ai flex-1">
